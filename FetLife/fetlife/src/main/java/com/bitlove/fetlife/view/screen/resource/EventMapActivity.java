...
public class EventMapActivity extends FragmentActivity implements OnMapReadyCallback, PlaceSelectionListener, GoogleMap.OnCameraMoveListener, ClusterManager.OnClusterClickListener<Event>, ClusterManager.OnClusterItemClickListener<Event>, ClusterManager.OnClusterInfoWindowClickListener<Event>, ClusterManager.OnClusterItemInfoWindowClickListener<Event>, GoogleMap.InfoWindowAdapter {
    ...
    private class DelayedEventRetriever implements Runnable {
        ...
        public void run() {
            ...
            if (runState.compareAndSet(WAITING,RUNNING)) {
                FetLifeApiIntentService.startClearApiCall(EventMapActivity.this,FetLifeApiIntentService.ACTION_APICALL_SEARCH_EVENT_BY_LOCATION,Float.toString(latitude),Float.toString(longitude),Float.toString(range));
            }
        }
    }
    ...
    private class CustomClusterRenderer extends DefaultClusterRenderer<Event> {
        ...
        public CustomClusterRenderer() {
            super(EventMapActivity.this, mMap, mClusterManager);
        }
...
//            mClusterManager.setOnClusterItemInfoWindowClickListener(this);
    ...
    public void onEventsRetrievedEvent(EventByLocationRetrievedEvent eventByLocationRetrievedEvent) {
    ...
    public void onClusterItemInfoWindowClick(Event event) {
        UrlUtil.openUrl(EventMapActivity.this, event.getUrl());
...
//        return true;
    ...
    public View getInfoWindow(Marker marker) {
        if (clickedClusterItem != null) {
            TextView textView = new TextView(EventMapActivity.this);
