...
2. Download and install the [fetlife-1.7.0.apk](https://github.com/fetlife/android/releases/download/v1.7.0/fetlife-1.7.0.apk) to your device

If you would like to have less kinky icon and app name to make the app look like a usual app on your device, you can rather download our vanilla version [fetlife-vanilla-1.7.0.apk](https://github.com/fetlife/android/releases/download/v1.7.0/fetlife-vanilla-1.7.0.apk)
